        ...
        return receiveBuilder()
                .match(Messages.WatchSearchResults.class, watchSearchResults -> {
                    ...
                    if (watchSearchResults != null) {
                        ...
                        askForStatuses(watchSearchResults.searchKey);
                ...
                .match(Messages.UnWatchSearchResults.class, unwatchSearchResults -> {
                    ...
                    if (unwatchSearchResults != null) {
                        searchResultsMap.get(unwatchSearchResults.searchKey).shutdown();
                        searchResultsMap.remove(unwatchSearchResults.searchKey);
                    }
                })
                .match(Messages.SearchingResults.class, message -> {
